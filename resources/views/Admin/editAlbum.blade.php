...
@section('content')
    ...
    <section class="albumPage">
        ...
        <form method="POST" action="{{route('editarAlbum')}}" id="formAlbum" enctype="multipart/form-data">
            @csrf
            
            <input type="hidden" name="idCategoria" value="{{$dadosAlbum->idCategoria}}">
            <input type="hidden" name="idAlbum" value="{{$dadosAlbum->idAlbum}}">

            <div class="areaFotoAlbum">
                <div id="fotoAlbum">
                    <img src="{{asset('storage/'.$dadosAlbum->fotoCapa)}}" 
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="tituloAlbum" 
                    value="{{$dadosAlbum->tituloAlbum}}">
            </div>

            <div class="form-group">
                <label >Descrição Album</label>
                <textarea class="form-control"  name="descricaoAlbum" id="" rows="4">
                    {{$dadosAlbum->descricaoAlbum}}
                </textarea>
            </div>
                
            <div class="form-group">
                <label>Data Evento</label>
                <input class="form-control" type="date" name="dataEvento" id="" value="{{$dadosAlbum->dataEvento}}">
            </div>

            <div class="form-group">
                <label>Slug</label>
                <input class="form-control" type="text" name="slug" id="" value="{{$dadosAlbum->slug}}">
            </div>
            <center>
