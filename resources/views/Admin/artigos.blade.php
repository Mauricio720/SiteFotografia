...
@section('content')
    ...
    <div class="containerBarraArtigo">
        <div class="barraArtigo">
            <div class="opcaoBarraArtigo barraArtigoSelected">Todos Artigos</div>
            <a href="{{route('meusArtigosPainel')}}" class="opcaoBarraArtigo">Meus Artigos</a>
        </div>
    </div>
    <section class="artigosPage">
        <div class="containerArtigos">
            <form id="formPesquisa" method="POST" action="{{route('pesquisarArtigo')}}">
                @csrf
            ...
            @foreach ($dadosArtigo as $artigos)
                @if($artigos->publicoCMS && in_array('ADM',$permissoes) 
                    || in_array('Adm Segundario',$permissoes)
                        || in_array('Artigos',$permissoes))
                <div class="artigo" style="background-image: url('{{asset('storage/'.$artigos['fotoCapa'])}}')">
                    ...
                    <a class="artigoLink" href="{{route('verArtigoCriacao',['idArtigo'
                        =>$artigos['idArtigo']])}}">
                            ...
                            <div class="urlArtigo">
                                {{route('verArtigoSite',['slugArtigo'=>$artigos['slug']])}}
                            </div>
                    </a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{route('cadastrarArtigo')}}"
                            ...
                            <div class="areaFotoArtigo" style="width:100%;">
        ...
        <script>
            var rotaStatusArtigo="{{route('atualizarStatusArtigo')}}";
        </script>
